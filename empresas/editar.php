...
<body>
    <div class="container mt-3">
        <div class="row justify-content-md-center">
            ...
            <?php
            include('connect.php');
            $idUsuario     = (int) filter_var($_REQUEST['update'], FILTER_SANITIZE_NUMBER_INT);
            ...
            <div class="col-md-5 mb-3">
                ...
                <form method="POST" action="action.php?metodo=2" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Plan:
                            <select class="form-select" name="plan" required>
                                ...
                                include 'connect.php';
                                $planactual = $dataUsuario['plan'];
                                $consultaCdfi = "SELECT * FROM planes WHERE id = '$planactual'";
                                $consultaUsuario = "SELECT * FROM planes";
                                $ejectuar = mysqli_query($con, $consultaUsuario);
                                $querycfdi = mysqli_query($con, $consultaCdfi);
                                $dataCdfi   = mysqli_fetch_array($querycfdi);
                                ...
                                ?>
                                <option value="<?php echo $dataCdfi['id']; ?>" selected><?php echo $dataCdfi['tipo']; ?>
                                    <?php
                    ...
                    <input type="text" name="actual" value="<?php echo $planactual; ?>" hidden>
                    <div class="mb-3">
