...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li style="margin-left: 30px" class="nav-item">
                        <a class="nav-link" href="modificados.php">Clientes Modificados</a>
                    </li>
                    <li style="margin-left: 30px" class="nav-item">
                        <a class="nav-link active" href="">Reportes de Clientes</a>
                    </li>
                    <li style="margin-left: 30px" class="nav-item">
        ...
        <div class="row">
            ...
            ?>
                <div class="col-md-8 text-center">
                    <h3 class="text-center">Clientes registrados <?php echo '(' . $totalUsuarios . ')'; ?>
                    </h3>
                    <div class="row">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <button class="btn  btn-success" onclick="location.href='reporte.php'">
                    Nueva Busqueda
                </button>
            </div>
            <div class="col-md-4">
                <a href="../excelcliente.php?id=<?php echo $empresa ?>"> <img src="../img/aaa.png" width="10%"></a>
            </div>
        </div>
