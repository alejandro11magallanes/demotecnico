...
if (isset($_POST['submit'])) {
    ...
    if (count($errors) == 0) {
        ...
        $msj .= '<p>El cliente solicita una prueba de piloto favor de contactarlo para asignarle el plan</p>';
        $msj .= "Nombre del Cliente:";
        $msj .= '<p>' . $nombre . '</p>';
        ...
        try {
            ...
            $mail->isHTML(true);
            $mail->Subject = 'Un cliente ha solicitado una prueba Piloto';
...
<body>
    ...
    <br />
    <div class="container">
        <h3>Solicitud de plan de Piloto sin costo</h3>
        <?php
        if (isset($errors)) {
            if (count($errors) > 0) {
        ?>
        ...
        <div class="row">
            <div class="col-md-3">
                <div id="piloto" class="text-center">
                    <h3 id="titulo-plan"><b>Piloto</b></h3>
                    <br />

                    <h4 id="titulo-precio">Sin costo</h4>
                    <br />
                    <br />
                    <p style="font-size: 25px;">
                        <b>preset</b> descarga de las Constancias de Situación Fiscal y el
                        envío a <b>5 Contactos por una sola vez.</b>
                    </p>
                    <br><br><br><br>
                </div>
            </div>
            <div id="pilotos" class="col-md-6">

                <form style="margin-top: 80px;" class="form" method="POST"
                    action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" autocomplete="off">
                    <div class="mb-3">
