...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li style="margin-left: 30px" class="nav-item">
                        <a class="nav-link active" href="">Proveedores Modificados</a>
                    </li>
                    <li style="margin-left: 30px" class="nav-item">
                    ...
                    <li style="margin-left: 30px" class="nav-item">
                        <a class="nav-link " href="panel.php">Reportes de Proveedores</a>
                    </li>
                </ul>
            </div>
    ...
    <div class="container mt-3">
        <div class="row justify-content-md-center">
            <div class="col-md-12">
                <h2 class="text-center mt-3">Reportes de Proveedores Modificados en su correo</h2>
                <hr class="mb-3">
            </div>
        </div>
        <h5>Selecciona un fecha para conocer los contactos que se han actualizado a partir de ella</h5>
        <div class="row">
        ...
        <div class="row">
            ...
            ?>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            <button class="btn  btn-success" onclick="location.href='fecha.php'">
                                Nueva Busqueda
                            </button>
                        </div>
                        <div class="col-md-4">
                            <a href="exfecha.php?id=<?php echo $fecha ?>&user=<?php echo $requerido ?>"> <img src="../img/aaa.png" width="10%"></a>
                        </div>
                    </div>
